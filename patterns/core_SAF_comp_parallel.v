...
// Fri Dec  6 17:45:32 2024
// Module under test: core
// Generated from original STIL file : "core_SAF_comp_parallel.stil"
...
`define TDATA_FILE "/home/m110/m110063553/DFT/testcase_dftmax_ultra/atpg/patterns/core_SAF_comp_parallel.dat"
`ifndef XTB_DUT_HIER 
...
`define MAXTB_HEADER " MAX TB Version R-2020.09-SP5\n Test Protocol File generated from original file \"core_SAF_comp_parallel.stil\"\n STIL file version: 1.0"
`define MAXTB_H_S "#############################################################################"
  ...
  endtask
   ...
   always @(start_part) begin: _burst__pattern__proc_unit
     ...
     if (diagm > 0) begin
       ...
       `else 
         diag_file = "core_SAF_comp_parallel.diag"; 
       `endif
   ...
   initial begin: _burst__pattern__init_unit
     ...
     `ifdef tmax_vcde
       $display("XTB: Dumping Extended VCD information in file \"core_SAF_comp_parallel.vcd\"");
       $dumpports(`XTB_DUT_HIER, "core_SAF_comp_parallel.vcd");
     `endif
